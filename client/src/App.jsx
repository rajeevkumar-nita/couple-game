...
// const socket = io.connect("https://couple-game-cj16.onrender.com"); // Your Render URL

// // Sounds
// const AUDIO_WIN = new Audio('https://assets.mixkit.co/active_storage/sfx/2000/2000-preview.mp3');
// const AUDIO_LOSE = new Audio('https://assets.mixkit.co/active_storage/sfx/2003/2003-preview.mp3');
// const AUDIO_MOVE = new Audio('https://assets.mixkit.co/active_storage/sfx/2578/2578-preview.mp3'); 
// const AUDIO_CURSE = new Audio('https://assets.mixkit.co/active_storage/sfx/243/243-preview.mp3'); // New Scary Sound
// AUDIO_MOVE.volume = 0.2;
...
//   // --- MOVEMENT LOGIC (With Inversion) ---
//   const movePlayer = (dir) => {
//     if (role !== 'walker' || !gameStarted || winner || gameOverMsg) return;
    
//     let finalDir = dir;

//     // IF CURSED: REVERSE DIRECTION
...
//     window.addEventListener('keydown', handleKeyDown);
//     return () => window.removeEventListener('keydown', handleKeyDown);
//   }, [role, gameStarted, room, winner, gameOverMsg, activeCurse]); // Added activeCurse dependency
...
//       setActiveCurse(null); // Reset curse on new game
//     });
...
//       {/* CURSE ALERT OVERLAY */}
//       {activeCurse === 'MIRROR' && (
//         <div className="absolute top-20 z-10 animate-pulse">
//            <div className="bg-red-600 text-white px-6 py-2 rounded-full font-bold shadow-lg border-2 border-white text-xl">
//              ⚠️ MIRROR CURSE ACTIVE! Controls Reversed! ⚠️
//            </div>
//         </div>
//       )}
